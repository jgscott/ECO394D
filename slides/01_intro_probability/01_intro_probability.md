...
<img src="fig/kawhi_leonard.jpg" title="plot of chunk unnamed-chunk-1" alt="plot of chunk unnamed-chunk-1" width="650px" style="display: block; margin: auto;" />
...
<img src="fig/grandpa_basketball.jpg" title="plot of chunk unnamed-chunk-2" alt="plot of chunk unnamed-chunk-2" width="650px" style="display: block; margin: auto;" />
...
- Wild but true!  It is possible to define bizarre sets for which there is _no meaningful notion of that set's size_.   (If you care: Google terms like "non-measurable set", "Vitali set", and "Banach-Tarski paradox").  
- But it's actually really hard to construct such a crazy set.  Pretty much every "normal" set you might care about (like intervals and unions of intervals) can be assigned a well-defined size.  Technically speaking, these are called the _Borel sets._  
...
Let's see why this axiom makes sense.
...
Figure courtesy David Speigelhalter and Jenny Gage.
...
<img src="fig/wald_table1.png" title="plot of chunk unnamed-chunk-8" alt="plot of chunk unnamed-chunk-8" width="650px" style="display: block; margin: auto;" />
...
Wald was able to reconstruct the joint distribution over damage type and mission result:  

<img src="fig/wald_table2.png" title="plot of chunk unnamed-chunk-9" alt="plot of chunk unnamed-chunk-9" width="750px" style="display: block; margin: auto;" />
...
Solution: go to the data!  (Remember, you're Netflix: you have tons of it.)  Suppose your database on 5 million subscribers like Linda reveals the following pattern:  

<img src="fig/netflix_table1.png" title="plot of chunk unnamed-chunk-10" alt="plot of chunk unnamed-chunk-10" width="650px" style="display: block; margin: auto;" />
...
This table exhibits something called _Simpson's paradox_.  Senior doctors have:  
...
- The senior doctors, meanwhile, work a much higher fraction of the harder cases.  Their overall complication rate reflects this burden.  
...
There are only two types of deliveries in the table: easy and hard.  So:  
...
Virginia Delaney-Black and her colleagues at Wayne State University gave an anonymous survey teenagers in Detroit:
- 432 teens were asked whether they had used various illegal drugs.  
- Of these 432, 211 of them also agreed to give a hair sample.  
...
Delaney-Black's work poses the question: __can we trust any of it?__
...
Independence is usually something we _choose to assume_ for the purpose of making calculations easier.  For example:  
...
- A child goes 200 school days without catching a cold from other kids at school.  
...
- Every day you have a single mid-morning Tic-Tac, which has 2 calories.  
- One day, you decide to give it up.  
- But you decide to go slowly: you'll forego that Tic-Tac only once every 10 days.  
...
- These probabilities won't be _exactly_ alike because of statistical fluctuations.  
- But with enough data they should be close if $A$ and $B$ are independent.  


Example: the hot hand  
========

<img src="fig/nbajam.jpg" title="plot of chunk unnamed-chunk-12" alt="plot of chunk unnamed-chunk-12" width="650px" style="display: block; margin: auto;" />

Example: the hot hand  
========

The "hot hand hypothesis" says that if a player makes their _previous_ shot, they're more likely to make their _next_ shot:  
...
Let's look at some data on shooting percentages for the 1980--81 Philadelphia 76ers.  
...
<img src="fig/julius_irving.jpg" title="plot of chunk unnamed-chunk-13" alt="plot of chunk unnamed-chunk-13" width="350px" style="display: block; margin: auto;" />
...
__Which hypothesis looks right: hot hand or independence?__
...
My four Monroe cousins are all colorblind.  
...
<img src="fig/colorblind_sweater.jpg" title="plot of chunk unnamed-chunk-14" alt="plot of chunk unnamed-chunk-14" width="350px" style="display: block; margin: auto;" />
...
But you'd be surprised at how often people make this mistake!  We might call this the "fallacy of mistaken compounding."  
