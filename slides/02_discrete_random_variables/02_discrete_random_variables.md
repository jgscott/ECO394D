...
- Intro to parametric models: the Poisson distribution  
...
- you "expect" that your newborn child will have one 0.97 ovaries (since 100/206 newborns are female).      
...
- Let's prove this on the board.  
- Maybe not super intuitive, but it is sometimes useful for calculating stuff.  
